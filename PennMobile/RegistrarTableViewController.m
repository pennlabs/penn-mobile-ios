...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar {
    ...
    //fixes crash when clear button is clicked after search
    self.registrySearchBar.text=@"";
}
...
//    }
    ...
    for(NSDictionary *courseData in [returned objectForKey:@"courses"]) {
        ...
        for(NSDictionary *courseData2 in courseData[@"instructors"]) {
            new.primaryProf = courseData2[@"name"];
        }
