...
class MapViewController: UIViewController {
    ...
    var region: MKCoordinateRegion = PennLocation.shared.getDefaultRegion(at: .far) {
        didSet {
    ...
    fileprivate func showCoordinates(searchTerm: String) {
        self.region = MKCoordinateRegion.init(center: PennLocation.shared.getDefault(), latitudinalMeters: PennCoordinateScale.mid.rawValue, longitudinalMeters: PennCoordinateScale.mid.rawValue)
