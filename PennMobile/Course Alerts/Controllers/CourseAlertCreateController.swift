...
extension CourseAlertCreateController: ShowsAlert {
    ...
    fileprivate func confirmAlert(section: CourseSection) {
        ...
        self.showOption(withMsg: message, title: "Confirm New Alert", onAccept: {
            CourseAlertNetworkManager.instance.createRegistration(section: section.section, autoResubscribe: (self.alertSwitcher.selectedSegmentIndex == 1), callback: {(success, response, _) in
