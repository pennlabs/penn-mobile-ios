...
protocol ShowsAlertForError : ShowsAlert {
    func showAlertForError<T>(result: Result<T, NetworkingError>, title: String, success: @escaping (T) -> Void, noInternet: (() -> Void)?, parsingError: (() -> Void)?, serverError: (() -> Void)?, jsonError: (() -> Void)?, authenticationError: (() -> Void)?, other: (() -> Void)?)
}

extension ShowsAlertForError {
    func showAlertForError<T>(result: Result<T, NetworkingError>, title: String, success: @escaping (T) -> Void, noInternet: (() -> Void)? = nil, parsingError: (() -> Void)? = nil, serverError: (() -> Void)? = nil, jsonError: (() -> Void)? = nil, authenticationError: (() -> Void)? = nil, other: (() -> Void)? = nil) {
        switch result {
        ...
        case .failure(.parsingError):
            self.showAlert(withMsg: "Penn's \(title) servers are currently not updating. We hope this will be fixed shortly", title: "Uh oh!", completion: parsingError)
        ...
        case .failure(.jsonError):
            self.showAlert(withMsg: "Penn's \(title) servers are currently not updating. We hope this will be fixed shortly", title: "Uh oh!", completion: jsonError)
